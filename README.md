...
## 8. 기존 결과 요약
노트북에 기록된 성능은 학습 세트 기준 **RMSE 약 44,756.90 / R² 약 0.593**, 테스트 세트 기준 **RMSE 약 52,274.27 / R² 약 0.498**입니다. 즉, 기본적인 예측 신호는 학습했지만 아직 개선 여지가 충분한 베이스라인 모델로 볼 수 있습니다.
[프로젝트 노트북](https://www.genspark.ai/api/files/s/7Kbxsdlg)
