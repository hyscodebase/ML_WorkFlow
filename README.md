...
## 15. 다음 기수용 제안 미션
### 기본 미션
- 기존 노트북을 재현하고 결과를 설명하기
- 핵심 변수 3개 이상에 대해 시각화 및 해석하기
- 베이스라인 모델 성능 재측정하기

### 심화 미션
- 다른 회귀 모델 2개 이상과 성능 비교하기
- 새로운 피처 엔지니어링 2개 이상 적용하기
- 모델 해석 결과를 포함한 보고서 작성하기

### 확장 미션
- 웹앱 배포 또는 발표 자료 제작
- “연봉 추천기” 형태의 서비스 아이디어 제안하기

## 16. 한 줄 소개 문구(홍보용)
> 데이터 직군의 경력, 직무, 근무 형태, 지역 정보를 바탕으로 연봉을 예측하고, EDA부터 딥러닝 회귀 모델까지 경험해보는 실전형 데이터 분석 프로젝트

---
필요하면 이 README를 기준으로 제가 바로 이어서 **1) 더 짧은 버전**, **2) 발표용 버전**, **3) GitHub 업로드용 깔끔한 버전**, **4) 팀 프로젝트 공고문 버전**까지 추가로 정리해드릴 수 있습니다.
